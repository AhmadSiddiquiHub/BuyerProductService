...
import { CampaignVendorsRepository } from '../repositories/CampaignVendorsRepository';
...
export class CampaignVendorsService {
    ...
    constructor(
        @OrmRepository() private repo: CampaignVendorsRepository,
        @Logger(__filename) private log: LoggerInterface) {
    }

    // create Country
    public async create(cmpgn: any): Promise<CampaignVendors> {
    ...
    // update cmpgn
    public update(id: any, cmpgn: CampaignVendors): Promise<any> {
        cmpgn.id = id;
