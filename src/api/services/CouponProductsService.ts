...
import { CouponProductsRepository } from '../repositories/CouponProductsRepository';

@Service()
export class CouponProductsService {

    constructor(@OrmRepository() private repo: CouponProductsRepository
    ) {
    }
